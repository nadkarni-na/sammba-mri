...
for dir in $(find -mindepth 1 -maxdepth 1 -type d); do
	...
	3dresample -rmode Cubic -master $savedir/emptytemplate.nii.gz -prefix $dir/anatCC.nii.gz -inset $dir/anat.nii.gz
	3dresample -rmode Cubic -master $savedir/emptytemplate.nii.gz -prefix $dir/UnCC.nii.gz -inset $dir/Un.nii.gz
	3dresample -rmode Cubic -master $savedir/emptytemplate.nii.gz -prefix $dir/UnBmCC.nii.gz -inset $dir/UnBm.nii.gz
	3dresample -rmode Cubic -master $savedir/emptytemplate.nii.gz -prefix $dir/UnBmBeCC.nii.gz -inset $dir/UnBmBe.nii.gz
