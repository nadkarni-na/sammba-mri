...
#%%    
    ...
    if os.path.exists(anatstem + '.nii.gz'):
...
#%%
        ...
        #separate as 3dAllineate performs well on brain image, and 3dQwarp well
        #on whole head
...
#%%
        ...
        #template. don't initiate straight from the original with an iniwarp
...
#%%
        ...
        with open(logfile, 'a') as myfile:
            myfile.write(anatstem + '.nii.gz' + ' not found')
